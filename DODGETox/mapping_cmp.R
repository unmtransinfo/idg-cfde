...
LS_UM <- read_delim(paste0(Sys.getenv()["HOME"], "/../data/CFDE/DODGETox/", fname_um), "\t", col_names = c("SMILES", "LS_ID"))
setDT(LS_UM)
...
LS_MS <- read_delim(paste0(Sys.getenv()["HOME"], "/../data/CFDE/DODGETox/", fname_ms), "\t", col_names = c("LS_ID", "TERM"))
setDT(LS_MS)
